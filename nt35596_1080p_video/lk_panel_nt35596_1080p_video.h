						    ...
						    struct mdss_dsi_phy_ctrl *phy_db)
{
	...
	pinfo->mipi.panel_on_cmds = nt35596_1080p_video_on_command;
	pinfo->mipi.panel_off_cmds = nt35596_1080p_video_off_command;
	pinfo->mipi.num_of_panel_on_cmds = ARRAY_SIZE(nt35596_1080p_video_on_command);
	pinfo->mipi.num_of_panel_off_cmds = ARRAY_SIZE(nt35596_1080p_video_off_command);
